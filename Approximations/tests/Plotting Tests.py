...
file_path="Approximations/run_data/test_data_2/simple_test_2.txt"
plot_path="Approximations/images/generation results/test_data/"
plot_title="simple_test_2.png"
