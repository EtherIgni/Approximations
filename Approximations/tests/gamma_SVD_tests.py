...
from Approximations.models import gamma_SVD_model,generic_model_gen
...
problem=generic_model_gen.create_leveled_model(separation_energy,
                                               ...
                                               energy_grid_buffer,
                                               energy_grid_size,
                                               gamma_SVD_model.Gamma_SVD)
test_gamma=problem.get_gamma_matrix()
print(test_gamma)
initial_estimate=initial_estimates.gamma_SVD_approx(test_gamma)
